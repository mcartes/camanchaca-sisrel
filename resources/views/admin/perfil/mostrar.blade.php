                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('admin.clave.cambiar', [$usuario->usua_rut, $usuario->rous_codigo]) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Cambiar contraseña"><i class="fas fa-user-lock"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.perfil.update', [$usuario->usua_rut, $usuario->rous_codigo]) }}" method="POST">
                            @method('PUT')
                            @csrf
