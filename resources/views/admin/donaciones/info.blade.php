                                    ...
                                    <table class="table table-striped table-md">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($donacion->dona_fecha_entrega)->format('d-m-Y') }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($donacion->dona_creado)->format('d-m-Y') }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Fecha última actualización</strong></td>
                                                <td>{{ \Carbon\Carbon::parse($donacion->dona_actualizado)->format('d-m-Y') }}</td>
                                            </tr>
                                            <tr>
