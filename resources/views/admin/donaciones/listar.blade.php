                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-md-4 col-lg-4">
                                    <div style="position: absolute; top: 50%; transform: translateY(-50%);">
                                        ...
                                        <a href="{{ route('admin.donaciones.listar') }}" type="button" class="btn btn-primary mr-1 waves-effect"><i class="fas fa-broom"></i> Limpiar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-striped table-md" id="tableExport" style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.donaciones.info',$donacion->dona_codigo)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Ver detalles"><i class="fas fa-eye"></i></a>
                                            <a href="{{route('admin.donaciones.editar',$donacion->dona_codigo)}}" class="btn btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a>
                                            <form action="{{route('admin.donaciones.eliminar',$donacion->dona_codigo)}}" method="POST" style="display: inline-block">
                                                @csrf
                                                <button type="submit" class="btn btn-icon btn-danger"><i class="fas fa-trash" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
