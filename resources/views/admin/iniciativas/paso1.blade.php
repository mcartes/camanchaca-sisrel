        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if (isset($iniciativa))
                            <form action="{{ route('admin.paso1.actualizar', $iniciativa->inic_codigo) }}" method="POST">
                                @method('PUT')
                                @csrf
                        @else
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="text-right">
                                        ...
                                        @else
                                            <a href="{{ route('admin.paso1.crear') }}" type="button" class="btn btn-warning waves-effect">Recargar</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
