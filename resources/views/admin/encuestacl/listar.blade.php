...
@section('contenido')
                                    ...
                                    <tbody>
                                        @foreach ($encuestacl as $cl)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" onclick="editarCacl($cacl->cacl_codigo)"></a>
                                                    <button type="button" class="btn btn-icon btn-warning"
                                                        data-toggle="modal"
                                                        data-target="#modalEditarencuestacl-{{ $cl->encl_codigo }}"
                                                        title="Editar"><i class="fas fa-edit"></i></button>
                                                    <form
                                                        action="{{ route('admin.encuestacl.eliminar', $cl->encl_codigo) }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.encuestacl.guardar') }}" method="POST">
                        @csrf
        ...
        <div class="modal fade" id="modalEditarencuestacl-{{ $cl->encl_codigo }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.encuestacl.actualizar', $cl->encl_codigo) }}" method="POST">
                            @method('PUT')
                            @csrf
    ...
    <script>
        function editarCacl(cacl_codigo) {
            $('#modalEditarencuestacl').modal('show');
        }
    </script>
