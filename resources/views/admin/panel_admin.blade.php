...
@section('acceso')
    <ul class="sidebar-menu">
        ...
        <li class="{{
                Route::is('admin.paso1.crear') || Route::is('admin.paso1.editar') ||
                Route::is('admin.paso2.crear') || Route::is('admin.paso2.editar') ||
                Route::is('admin.paso3.crear') || Route::is('admin.paso3.editar') ||
                Route::is('admin.paso4.crear') ||
                Route::is('admin.iniciativas.index') || Route::is('admin.iniciativas.show') ||
                Route::is('admin.evidencia.listar') || Route::is('admin.evidencia.guardar') || Route::is('admin.evidencia.editar') || Route::is('admin.evidencia.actualizar') || Route::is('admin.evidencia.descargar') || Route::is('admin.evidencia.eliminar') ||
                Route::is('admin.evaluacion.index') ||
                Route::is('admin.cobertura.index') ||
                Route::is('admin.resultados.index')
                ? 'dropdown active' : 'dropdown'
            }}">
            <a href="javascript:void(0)" class="menu-toggle nav-link has-dropdown"><i data-feather="slack"></i><span>Iniciativas</span></a>
            <ul class="dropdown-menu">
        ...
        <li class="{{
                Route::is('admin.actividad.crear') || Route::is('admin.actividad.editar') || Route::is('admin.actividad.participantes.editar') ||
                Route::is('admin.actividad.listar') || Route::is('admin.actividad.mostrar') ||
                Route::is('admin.donaciones.crear') || Route::is('admin.donaciones.listar') || Route::is('admin.donaciones.editar') || Route::is('admin.donaciones.info')
                ? 'dropdown active' : 'dropdown'
            }}">
        ...
        <li class="{{ Route::is('admin.map') ? 'dropdown active' : 'dropdown' }}">
            <a class="nav-link" href="{{route('admin.map')}}"><i data-feather="map"></i><span>Mapa</span></a></li>
        </li>
        <li class="{{
                Route::is('admin.unidades.listar') || Route::is('admin.registrar.unidad') || Route::is('admin.editar.unidad') ||
                Route::is('admin.pilares.listar') ||
                Route::is('admin.impactos.listar') ||
                Route::is('admin.convenios.listar') || Route::is('admin.convenios.registrar') || Route::is('admin.convenios.editar') ||
                Route::is('admin.entornos.listar') ||
                Route::is('admin.subentornos.listar') ||
                Route::is('admin.listar.org') || Route::is('admin.crear.org') || Route::is('admin.editar.org') ||
                Route::is('admin.crear_dirigente.org') || Route::is('admin.dirigente.editar') || Route::is('admin.dirigente.crear') ||
                Route::is('admin.listar.encuestapr') || Route::is('admin.crear.encuestapr') || Route::is('admin.encuestapr.editar') ||
                Route::is('admin.encuestacl.listar') || Route::is('admin.encuestacl.registrar') || Route::is('admin.encuestacl.editar') ||
        ...
        <li class="{{
                Route::is('admin.listar.usuario') || Route::is('admin.editar.usuario') || Route::is('admin.crear.usuario') ||
                Route::is('admin.claveusuario.cambiar') || Route::is('admin.claveusuario.actualizar')
                ? 'dropdown active' : 'dropdown' 
            }}">
