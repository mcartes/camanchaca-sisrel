                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <a type="button" class="btn btn-primary" href="{{ route('admin.actividad.crear') }}"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label>Comunas</label>
                                            <select class="form-control select2" style="width: 100%" id="comu_codigo"
                                                name="comu_codigo">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%" id="orga_codigo"
                                                name="orga_codigo">
                                                <option value="" selected disabled>Seleccione...</option>
                                    ...
                                    <div class="col-xl-12 col-md-12 col-lg-12 text-right mb-12">
                                        ...
                                        <a href="{{ route('admin.actividad.listar') }}" type="button"
                                        ...
                                        @if ($actividades != null)
                                            <tr>
                                                @foreach ($actividades as $actividad)
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.actividad.mostrar', $actividad->acti_codigo) }}"
                                                            class="btn btn-icon btn-primary" data-toggle="tooltip"
                                                            data-placement="top" title="Ver detalles"><i
                                                                class="fas fa-eye"></i></a>
                                                        <a href="{{ route('admin.actividades.evidencias.listar', $actividad->acti_codigo) }}"
                                                            class="btn btn-icon btn-warning" data-toggle="tooltip"
                                                            data-placement="top" title="Adjuntar evidencia"><i
                                                                class="fas fa-paperclip"></i></a>
                                                        <a href="{{ route('admin.actividad.editar', $actividad->acti_codigo) }}"
                                                            class="btn btn-icon btn-warning" data-toggle="tooltip"
                                                            data-placement="top" title="Editar"><i
                                                                class="fas fa-edit"></i></a>
                                                        <form
                                                            action="{{ route('admin.actividad.eliminar', $actividad->acti_codigo) }}"
