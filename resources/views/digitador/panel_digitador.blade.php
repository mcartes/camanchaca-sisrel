...
<ul class="sidebar-menu">
    ...
    <li class="{{
            ...
            Route::is('digitador.paso3.crear') || Route::is('digitador.paso3.editar') ||
            Route::is('digitador.paso4.crear') ||
            Route::is('digitador.iniciativas.index') || Route::is('digitador.iniciativas.show') ||
            Route::is('digitador.evidencia.listar') || Route::is('digitador.evidencia.guardar') || Route::is('digitador.evidencia.editar') || Route::is('digitador.evidencia.actualizar') || Route::is('digitador.evidencia.descargar') || Route::is('digitador.evidencia.eliminar') ||
    ...
    <li class="{{
            Route::is('digitador.actividad.crear') || Route::is('digitador.actividad.editar') || Route::is('digitador.actividad.participantes.editar') ||
            Route::is('digitador.actividad.listar') || Route::is('digitador.actividad.mostrar') ||
