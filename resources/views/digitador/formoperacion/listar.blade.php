...
@section('contenido')
                                        ...
                                        @foreach ($evalucionOperaciones as $evop)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('digitador.operacion.borrar', $evop->evop_codigo) }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('digitador.operacion.crear') }}" method="POST">
                        @csrf
        ...
        <div class="modal fade" id="modalEditarevalucionOperaciones-{{ $evop->evop_codigo }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('digitador.operacion.actualizar', $evop->evop_codigo) }}" method="POST">
                            @method('PUT')
                            @csrf
    ...
    <script>
        ...
        selectRegion.addEventListener('change', function(e) {
            ...
            fetch("{{ route('digitador.operaciones.comunas') }}", {
                method: 'POST',
                body: JSON.stringify({
        ...
        selectComuna.addEventListener('change', function(e) {
            $('#unid_codigo').val('').prop('selected', true);
            fetch("{{ route('digitador.operaciones.unidades') }}", {
                method: 'POST',
                body: JSON.stringify({
