                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="javascript:void(0)" class="btn btn-primary" onclick="agregar()"><i class="fas fa-plus"></i> Nueva evidencia</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($evidencias as $evidencia)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('digitador.evidencia.descargar', $evidencia->inev_codigo) }}" method="POST" style="display: inline-block">
                                                    @csrf
                                                ...
                                                <form action="{{ route('digitador.evidencia.eliminar', $evidencia->inev_codigo) }}" method="POST" style="display: inline-block">
                                                    @method('DELETE')
                                                    @csrf
...
<div class="modal fade" id="modalAgregarEvidencia" tabindex="-1" role="dialog" aria-labelledby="agregarEvidencia" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('digitador.evidencia.guardar', $iniciativa->inic_codigo) }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label>Nombre</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="inev_nombre" name="inev_nombre" placeholder="" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="inev_archivo" name="inev_archivo" accept=".png,.jpg,.jpeg,.pdf,.xls,.xlsx,.ppt,.pptx,.doc,.docx,.csv,.mp3,.mp4,.avi"><br>
...
<script src="{{ asset('public/js/digitador/iniciativas/evidencias.js') }}"></script>
