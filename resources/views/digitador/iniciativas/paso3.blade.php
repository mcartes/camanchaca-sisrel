                            ...
                            <div class="row mt-4">
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="text-right">
                                        <a href="{{ route('digitador.paso2.editar', $iniciativa->inic_codigo) }}" type="button" class="btn btn-primary mr-1 waves-effect"><i class="fas fa-chevron-left"></i> Volver al paso anterior</a>                                      
                                        ...
                                        <a href="{{ route('digitador.paso3.editar', $iniciativa->inic_codigo) }}" type="button" class="btn btn-warning waves-effect">Recargar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-whitesmoke br">
                <a href="{{ route('digitador.iniciativas.index') }}" type="button" class="btn btn-primary">Continuar</a>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('public/js/digitador/iniciativas/paso3.js') }}"></script>
