                                        ...
                                        @foreach ($evaluacionprensa as $evpr)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        action="{{ route('digitador.evaluacionprensa.borrar', $evpr->evpr_codigo) }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('digitador.evaluacionprensa.guardar') }}" method="POST">
                        @csrf
        ...
        <div class="modal fade" id="modalEditarEvaluacionPrensa-{{ $evpr->evpr_codigo }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('digitador.evaluacionprensa.actualizar', $evpr->evpr_codigo) }}"
                            method="POST">
                            @method('PUT')
                            @csrf
