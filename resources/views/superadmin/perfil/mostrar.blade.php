                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('superadmin.clave.cambiar', $usuario->usua_rut) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Cambiar contraseña"><i class="fas fa-user-lock"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('superadmin.perfil.update', $usuario->usua_rut) }}" method="POST">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="run" name="run" value="{{$usuario->usua_rut }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
