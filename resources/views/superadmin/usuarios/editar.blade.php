                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('superadmin.claveusuario.cambiar', $usuario->usua_rut) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Cambiar contraseña"><i class="fas fa-user-lock"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('superadmin.usuario.actualizar', $usuario->usua_rut) }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ejemplo: 12345678-K" id="run" name="run" value="{{ @$usuario->usua_rut }}" autocomplete="off" disabled>
                                            </div>
                                            @if($errors->has('run'))
                                                <div class="alert alert-warning alert-dismissible show fade mt-2">
                                                    <div class="alert-body">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ route('superadmin.listar.usuarios') }}" type="button" class="btn btn-warning mr-1 waves-effect"><i class="fas fa-angle-left"></i> Volver al listado</a>
                                </div>
                            </form>
                        </div>
                    </div>
