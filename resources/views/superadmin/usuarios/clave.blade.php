            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('superadmin.claveusuario.actualizar', $usuario->usua_rut) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <a href="{{ route('superadmin.usuario.editar', $usuario->usua_rut) }}" type="button" class="btn btn-warning mr-1 waves-effect"><i class="fas fa-angle-left"></i> Regresar</a>
                                </div>
                            </form>
                        </div>
                    </div>
