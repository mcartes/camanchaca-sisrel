                                ...
                                <tbody>
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('superadmin.usuario.editar', $usuario->usua_rut) }}" class="btn btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Editar usuario"><i class="fas fa-edit"></i></a>
                                                @if ($usuario->usua_vigente=='N')
                                                ...
                                                @endif
                                                <a href="javascript:void(0)" class="btn btn-icon btn-danger" onclick="eliminarAdmin('{{ $usuario->usua_rut }}')" data-toggle="tooltip" data-placement="top" title="Eliminar usuario"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
<script>
    function eliminarAdmin(usua_rut) {
