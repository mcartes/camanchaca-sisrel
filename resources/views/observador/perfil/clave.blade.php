            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('observador.clave.actualizar', [$usuario->usua_rut, $usuario->rous_codigo]) }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $usuario->usua_rut }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <a href="{{ route('observador.perfil.show', [$usuario->usua_rut, $usuario->rous_codigo]) }}" type="button" class="btn btn-warning mr-1 waves-effect"><i class="fas fa-angle-left"></i> Regresar</a>
                                </div>
                            </form>
                        </div>
                    </div>
